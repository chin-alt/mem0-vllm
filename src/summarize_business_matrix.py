...
METRIC_COLUMNS = [
    ...
    "cuda_device_index",
    "cuda_device_name",
    "cuda_before_load_allocated_mib",
    "cuda_before_load_reserved_mib",
    "cuda_after_load_allocated_mib",
    "cuda_after_load_reserved_mib",
    "cuda_after_score_allocated_mib",
    "cuda_after_score_reserved_mib",
    "cuda_peak_allocated_mib",
    "cuda_peak_reserved_mib",
    "nvidia_smi_before_load_gpu_index",
    "nvidia_smi_before_load_gpu_uuid",
    "nvidia_smi_before_load_memory_used_mib",
    "nvidia_smi_before_load_memory_total_mib",
    "nvidia_smi_after_load_gpu_index",
    "nvidia_smi_after_load_gpu_uuid",
    "nvidia_smi_after_load_memory_used_mib",
    "nvidia_smi_after_load_memory_total_mib",
    "nvidia_smi_after_score_gpu_index",
    "nvidia_smi_after_score_gpu_uuid",
    "nvidia_smi_after_score_memory_used_mib",
    "nvidia_smi_after_score_memory_total_mib",
